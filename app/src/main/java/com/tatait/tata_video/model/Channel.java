...
//    public static final int HISTORY = 9;//历史记录
    ...
    public Channel(int id, Context context) {
        ...
        switch (channelId) {
            case SHOW:
                channelName = mContext.getResources().getString(com.tatait.tata_video.R.string.channel_series);
                break;
            case MOVIE:
                channelName = mContext.getResources().getString(com.tatait.tata_video.R.string.channel_movie);
                break;
            case COMIC:
                channelName = mContext.getResources().getString(com.tatait.tata_video.R.string.channel_comic);
                break;
            case DOCUMENTRY:
                channelName = mContext.getResources().getString(com.tatait.tata_video.R.string.channel_documentary);
                break;
            case MUSIC:
                channelName = mContext.getResources().getString(com.tatait.tata_video.R.string.channel_music);
                break;
            case VARIETY:
                channelName = mContext.getResources().getString(com.tatait.tata_video.R.string.channel_variety);
                break;
            case LIVE:
